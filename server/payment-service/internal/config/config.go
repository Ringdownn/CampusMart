...
func Load() Config {
	return Config{
		...
		AlipayAppID:         envOrDefault("ALIPAY_APP_ID", ""),
		AlipayNotifyURL:     envOrDefault("ALIPAY_NOTIFY_URL", "http://localhost:8080/app/payments/alipay/notify"),
		AlipayAppPrivateKey: firstEnv("ALIPAY_APP_PRIVATE_KEY", "ALIPAY_MERCHANT_PRIVATE_KEY"),
		AlipayPublicKey:     envOrDefault("ALIPAY_PUBLIC_KEY", ""),
		AlipayIsProduction:  envOrDefault("ALIPAY_IS_PRODUCTION", "false") == "true",
	}
}
